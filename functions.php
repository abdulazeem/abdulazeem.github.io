...
if ( !function_exists( 'bunnypresslite_singular_thumbnail' ) ) {
	function bunnypresslite_singular_thumbnail(){
		$allowed_tag = array( 'img' => array( 'id' => array (), 'class' => array (), 'style' => array (), 'itemprop' => array (), 'src' => array (), 'data-src' => array (), 'srcset' => array (), 'width' => array (), 'height' => array (), 'alt' => array (), 'title' => array (), ));
		$pattern = '/<img([^>]+?)\/?>/i';
...
if ( !function_exists( 'bunnypresslite_adjacent_post_link' ) ) {
	function bunnypresslite_adjacent_post_link($bunnypresslite_maxlen = -1, $bunnypresslite_format='&laquo; %link', $bunnypresslite_link='%title', $bunnypresslite_in_same_cat = false, $bunnypresslite_excluded_categories = '', $bunnypresslite_previous = true) {
		...
		$allowed_html = array(
			...
			'img' => array( 'id' => array (), 'class' => array (), 'style' => array (), 'align' => array (), 'src' => array (), 'data-src' => array (), 'data-lazy-src' => array (), 'border' => array (), 'width' => array (), 'height' => array (), 'alt' => array () ),
...
if ( !function_exists( 'bunnypresslite_scripts' ) ) {
	function bunnypresslite_scripts() {
		...
		wp_enqueue_script( 'bunnypresslite_script_js', get_template_directory_uri() . '/js/index.js' );
		if( is_singular() && comments_open() ) wp_enqueue_script('comment-reply');
		wp_enqueue_style( 'bunnypresslite_style', get_template_directory_uri() . '/css/firstveiw.css' );
		if( has_nav_menu( 'header-menu' ) ) wp_enqueue_style( 'bunnypresslite_header-menu', get_template_directory_uri() . '/css/header_menu.css' );
		if( bunnypresslite_display_totop() != 'totop4' ) wp_enqueue_style( 'totop', get_template_directory_uri() . '/css/totop.css' );
		...
		if( bunnypresslite_footerwidget() == '2') wp_enqueue_style( 'bunnypresslite_style_fw', get_template_directory_uri() . '/css/fw2.css' );
		if( bunnypresslite_footerwidget() == '3') wp_enqueue_style( 'bunnypresslite_style_fw', get_template_directory_uri() . '/css/fw3.css' );
		if( bunnypresslite_footerwidget() == '4') wp_enqueue_style( 'bunnypresslite_style_fw', get_template_directory_uri() . '/css/fw4.css' );
		if( bunnypresslite_footerwidget() == '5') wp_enqueue_style( 'bunnypresslite_style_fw', get_template_directory_uri() . '/css/fw5.css' );
