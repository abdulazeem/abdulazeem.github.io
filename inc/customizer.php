...
function bunnypresslite_theme_customizer_extension($wp_customize) {
	...
	'type' => 'radio',
	'choices' => array(
		'right' => __( '2 column right sidebar', 'bunnypresslite' ),
		'left' => __( '2 column left sidebar', 'bunnypresslite' ),
		'one' => __( '1 columnt', 'bunnypresslite' ),
	),
	'priority' => 10,
	));
...
function bunnypresslite_sanitize_analysis( $input ) {
	...
	$allowed_html = array(
		...
		'ins' => array( 'id' => array (), 'class' => array (), 'href' => array (), 'onclick' => array (), 'target' => array() ),
